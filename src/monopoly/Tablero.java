...
public class Tablero {
    ...
    public String listarPropiedadesEnVenta() {
        StringBuilder sb = new StringBuilder();
        ...
        for (ArrayList<Casilla> lado : posiciones) {
            for (Casilla casilla : lado) {
                if (casilla.esTipoComprable() && casilla.getDuenho() == banca) {
                    if (!hayPropiedades) {
                        sb.append("Propiedades en venta:\n");
                        hayPropiedades = true;
                    }
                    sb.append("- ").append(casilla.getNombre())
                            .append(" (").append(casilla.getTipo())
                            .append("): ").append(casilla.getValor())
                            .append("€\n");
                }
            }
        }
        ...
        if (!hayPropiedades) {
            return "No hay propiedades en venta.";
        }
